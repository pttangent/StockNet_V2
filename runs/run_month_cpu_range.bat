...
set "RUN_BAT_ARCHIVE=%OUTPUT_ROOT%\run_month_cpu_range.bat"
...
echo.
echo ============================================================
echo Starting StockNetV2 CPU rerun (headless)
echo ============================================================
...
cls
echo ============================================================
echo StockNetV2 CPU rerun (headless monitor)
echo ============================================================
echo Run name       : %RUN_NAME%
...
:DONE
echo.
echo [INFO] Rerun process exited.
if exist "%RUN_STDERR%" (
